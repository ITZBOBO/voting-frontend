...
import { getAdminElections, getCandidates } from "@/lib/services";
    ...
    <div style={{ maxWidth: "1100px" }}>
      ...
      <div style={{ background: "#fff", border: "1px solid #e8eaf0", borderRadius: "12px", overflow: "hidden" }}>
        ...
        {elections && elections.length > 0 ? (
          ...
          <div style={{ padding: "56px 24px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
      ...
      <style>{`
        ...
        @media (max-width: 860px) { .stats-responsive { grid-template-columns: repeat(2,1fr) !important; } }
