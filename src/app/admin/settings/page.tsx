  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <StatBox title="Security Status" value="All systems on" subtext="3 of 3 controls active" valueColor="text-green-600" />
      ...
      <SectionCard title="Voting Integrity Controls" description="Core protections for the election process" badge="Critical" badgeColor="red" icon={Shield}>
        <ToggleRow
      ...
      <SectionCard title="Audit & Activity Logging" description="Track all administrative actions for compliance" badge="Active" badgeColor="green" icon={ScrollText}>
        <ToggleRow
              ...
              <div key={u.id} className="flex flex-col sm:flex-row sm:items-center justify-between py-4 gap-3">
                ...
                <div className="flex items-center gap-2 flex-wrap sm:justify-end">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-md text-xs font-medium transition ${u.isActive ? "bg-green-100 text-green-700 hover:bg-green-200" : "bg-red-100 text-red-600 hover:bg-red-200"}`}
                  >
